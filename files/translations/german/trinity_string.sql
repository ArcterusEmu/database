...
UPDATE `trinity_string` SET `content_loc3`='|cffff0000[Systemnachricht]: %s|r' WHERE (`entry`='3');
...
UPDATE `trinity_string` SET `content_loc3`='Die neuen Passwörter stimmen nicht überein oder das alte Passwort ist falsch.' WHERE (`entry`='27');
...
UPDATE `trinity_string` SET `content_loc3`='Item ''%i'' ist bereits in der Liste des Verkäufers.' WHERE (`entry`='210');
...
UPDATE `trinity_string` SET `content_loc3`='%d - |cffffffff|Hgameobject:%d|h[%s X:%f Y:%f Z:%f MapId:%d]|h|r ' WHERE (`entry`='517');
...
UPDATE `trinity_string` SET `content_loc3`='Achtung: Du bist in einer Flugverbotszone und wirst gleich dismounted.' WHERE (`entry`='816');
...
UPDATE `trinity_string` SET `content_loc3`='|    Account    |       Charakter      |       IP        | GM | Expansion |' WHERE (`entry`='1010');
...
UPDATE `trinity_string` SET `content_loc3`='|%15s| %20s | %15s |%4d| %9d |' WHERE (`entry`='1013');
...
UPDATE `trinity_string` SET `content_loc3`='|cff00ff00Ticket|r:|cff00ccff %d.|r ' WHERE (`entry`='2017');
...
UPDATE `trinity_string` SET `content_loc3`='\n|cff00ff00Nachricht|r: \"%s\"|r ' WHERE (`entry`='2022');
UPDATE `trinity_string` SET `content_loc3`='\n|cff00ff00Kommentar|r: \"%s\"|r ' WHERE (`entry`='2023');
UPDATE `trinity_string` SET `content_loc3`='\n|cff00ccff%s|r |cff00ff00Kommentar hinzugefügt|r: \"%s\"|r ' WHERE (`entry`='2024');
...
/* trinity_string (`entry`='6604' - `entry`='6612' translation is missing */
...
/* trinity_string (`entry`='10056' - `entry`='10058' translation is missing */

UPDATE `trinity_string` SET `content_loc3`='Lasst die Schlacht um den Strand der Uralten beginnen!' WHERE (`entry`='10059');

/* trinity_string (`entry`='10060' - `entry`='10061' translation is missing */
